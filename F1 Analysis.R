...
#Remove columns and filter for qualifying position to be 3 or less
...
formula_1_data<-formula_1_data %>% filter(qual_gap>=0)
...
plot_quali<-formula_1_data_filtered %>% filter(grid > 1) %>% ggplot(formula_1_data_filtered,
                                                                    aes(x=qual_gap,
                                                                        y=finish_position,
                                                                        ))+
...
ggplot(formula_1_data_filtered,
       aes(x=qual_gap,y=finish_position))+
  geom_point()+theme_minimal()
